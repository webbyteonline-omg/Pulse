...
> = {
  ...
  assignment: { label: "Assignment", color: "#6C63FF", dim: "#6C63FF26", emoji: "📌" },
  holiday: { label: "Holiday", color: "#43D98C", dim: "#43D98C26", emoji: "🌴" },
...
> = {
  food: { label: "Food", color: "#FF6584", emoji: "🍔" },
  travel: { label: "Travel", color: "#6C63FF", emoji: "🚕" },
  shopping: { label: "Shopping", color: "#FFB347", emoji: "🛍️" },
  bills: { label: "Bills", color: "#43D98C", emoji: "🧾" },
  education: { label: "Education", color: "#5AB0FF", emoji: "📚" },
  health: { label: "Health", color: "#FF5C5C", emoji: "💊" },
  entertainment: { label: "Fun", color: "#C56CFF", emoji: "🎬" },
